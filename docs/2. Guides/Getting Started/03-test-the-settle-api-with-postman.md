...
action | Action to perform on payment request. [What is this?](./b3A6ODY4MjgyNA-merchant-payment-request-create#request-body)
currency | The currency used for the payment. [What is this?](./c2NoOjQwNjM0Ng-currency)
